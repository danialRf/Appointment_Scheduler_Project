...
namespace MyCmsWebApi2.Presentations.Controllers.UserControllers
{
    ...
    public class RegistrationController : ControllerBase
    {
        ...
        public RegistrationController(UserManager<ApplicationUser> userManager, IConfiguration configuration, JwtTokenGenerator jwtTokenGenerator, ApScDbContext dbContext, TokenValidationParameters validationParameters)
        {
